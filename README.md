...
### Sales by Year-Month: 
This tracks the monthly performance of an organization overtime.
### Year Over Year(YOY): 
This compares the sales of a specific month to the sales of the same month in the previous years.
...
There is a consistent decline in sales overtime and in the course of the year.
...
Having a total order of 274,914 and total sales of 3.48 billion dollars, there is a need to analyze where the bulk of our orders and sales is coming from. Thus, the sales channel( Online and offline sales channels).
Overall, online sales brought in the majority of sales orders and contributed significantly to the total sales(revenue) made.
In 2004, we see that there was a significant increase in sales orders from the online channel(70.79%) but it still did not contribute much to the total sales as it brought only 4.53%. Thus, the offline sales channel contributed 95.47% to total sales even with 29.21% of the sales orders. We can see that the online customers are only buying less expensive products from the online platforms which could be a result of a lack of trust, no diversity in payment options, lack of proper product descriptions with clear and compelling pictures, amongst others.
